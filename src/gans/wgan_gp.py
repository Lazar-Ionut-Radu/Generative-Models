...
class WGANGP(GANTemplate):
    def __init__(self, G, D, batch_size=64, steps_d=1, lambda_gp=10):
        super(WGANGP, self).__init__(G, D, batch_size, steps_d)
    ...
    def _calculate_gradient_penalty(self, samples_real, labels_real, samples_fake, labels_fake):
        ...
        # Compute gradient penalty ( ||∇ D(x)||_2 - 1 )^2
    ...
    def _calculate_discriminator_loss(self, samples_real, labels_real, samples_fake, labels_fake):
        ...
        gradient_penalty = self._calculate_gradient_penalty(samples_real, labels_real, samples_fake, labels_fake)
